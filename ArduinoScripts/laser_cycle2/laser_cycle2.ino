...
int TTL_state;
int cycle_num = 4;
int PMT_low_gain = 0; //the gain of PMT is reduced (use number between 0 and 4095)
int PMT_high_gain = 2000; //the gain of PMT is reduced (use number between 0 and 4095)
...
//  for(int j=0; j<5; j++) {  //for tests
  ...
  delay(213); //OFF time; 233 ms together with two PMT delays (2 x 10 ms)
  }
}
