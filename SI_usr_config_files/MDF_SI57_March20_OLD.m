...
beamDaqs(1).calOffsets = [-0.000801992 0];     % Array of beam calibration offset voltages for each beam calibration channel
...
%% MPC200 (MPC200)
comPort = 1;     % Integer identifying COM port for controller
